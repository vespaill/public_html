...
var content = {
    ...
    main: {
        'home.':
            '<div id="interests"><h2>interests.</h2><a href="#" onclick="return!1"><article><img src="assets/images/cacao.jpg" alt="cacao"><p>Nutrition</p></article></a><a href="#" onclick="return!1"><article><img src="assets/images/desktop.jpg" alt="desktop"><p>PC Gaming</p></article></a><a href="#" onclick="return!1"><article><img src="assets/images/darksouls.jpg" alt="darksouls"><p>Soulsbornekiro</p></article></a><a href="#" onclick="return!1"><article><img src="assets/images/deadlift.png" alt="deadlift"><p>Strength Training</p></article></a></div>',
        'class.':
