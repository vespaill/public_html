...
var elSubmitBtn = document.getElementById('submit-btn');// Get button element

elSubmitBtn.addEventListener('click', function(){       // Add event listener on click
    generateTable(4);                                   // It calls generateTable()
