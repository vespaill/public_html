...
function updateCurrent(el_ul, target) {
    ...
    /* Add an attribute of class with value of 'current' to our target navbarl link
       Our CSS will then highlight this navbar link. */
...
**        navbar link element, assumed to be the target of the given event e. **
*******************************************************************************/
function updateContent(e) {
    ...
    if (content.intro[targetText]) {                // If the content is valid
        if (debugging) console.log('Valid nav element clicked');
...
var el_first_nav_el_link = document.getElementById('navbar').firstChild.nextSibling.firstChild;
if (debugging) {
